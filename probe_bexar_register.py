"""
Probe -- Bexar County Tyler Odyssey Portal registration form. Dumps the real
sign-up fields before attempting registration for real (SYSTEM_GUIDE.md S6).
"""
import logging
import os
...
BASE_URL = 'https://portal-txbexar.tylertech.cloud/Portal/Home/Dashboard/29'
